package com.modernpos.tps_coffee.tps900.iccard;
...
import com.modernpos.tps_coffee.R;
...
public class SmarCardNewActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		/*LogCatHelper logCatHelper = LogCatHelper.getInstance(SmarCardNewActivity.this, Environment.getExternalStorageDirectory().getAbsolutePath());
		logCatHelper.start();*/
